...
<!--            </form>-->
    ...
    $args = array(
        ...
        'fields' => apply_filters( 'comment_form_default_fields', array(
            'author' => '<p class="comment-form-author"><span><input placeholder="' . __('Введіть ім\'я *', 'infomist') . '" id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30" ' . $aria_req . ' /></span></p>',
 )) );
