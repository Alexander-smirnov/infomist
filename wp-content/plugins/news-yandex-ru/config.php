...
<p>
<input class="news-yandex-ru-field" name="news_yandex_ru[alt]" type="text" value="<?=stripslashes(htmlspecialchars($this->cfg['alt']))?>" autocomplete="off">
</p>
