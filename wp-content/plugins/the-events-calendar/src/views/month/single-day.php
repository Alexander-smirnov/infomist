...
<?php if ( $day['view_more'] && tribe_events_is_view_enabled( 'day' ) ) : ?>
	<div class="tribe-events-viewmore">
		<?php
			...
			$view_all_label = sprintf( _n( 'Подивитись 1 %1$s', 'Переглянути всі %2$s %3$s', $day['total_events'], 'tribe-events-calendar' ), $events_label_singular, $day['total_events'], $events_label_plural );
