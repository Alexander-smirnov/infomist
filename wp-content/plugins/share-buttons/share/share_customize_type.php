<?php
	...
	if($customize_type=='original_count') {
		...
		$mailru .= "<noindex><a rel='nofollow' title='".__('Поширити у MyWorld', $this->plugin_domain)."' href=\"#mailru\" name=\"mailru\" onclick=\"new_window('http://connect.mail.ru/share?share_url=$url');\">";
		...
		$odkl .= "<noindex><a rel='nofollow' title='".__('Поширити у Odnoklassniki', $this->plugin_domain)."' href=\"#odnoklassniki\" name=\"odnoklassniki\" onclick=\"new_window('http://www.odnoklassniki.ru/dk?st.cmd=addShare&st.s=1&st._surl=$url');\">";
		...
		$twitter .= "<noindex><a rel='nofollow' title='".__('Поширити у Twitter', $this->plugin_domain)."' href=\"#twitter\" name=\"twitter\" onclick=\"new_window('http://twitter.com/share?&text=$title%20-%20&url=$url$via_new');\">";
		...
		$facebook .= "<noindex><a rel='nofollow' title='".__('Поширити у Facebook', $this->plugin_domain)."' href=\"#facebook\" name=\"facebook\" onclick=\"new_window('http://www.facebook.com/sharer.php?u=$url');\">";
		...
		$livejournal .= "<noindex><a rel='nofollow' title='".__('Поширити у LiveJournal', $this->plugin_domain)."' href=\"http://www.livejournal.com/update.bml?event=".$url."&subject=".$title."\" target=\"_blank\" name =\"livejournal\"/>";
		...
		$googlebuzz .= "<noindex><a rel='nofollow' title='".__('Поширити у Google Buzz', $this->plugin_domain)."' href=\"http://www.google.com/buzz/post?message=".$title."&url=".$url."\">";
		...
		$yandex .= "<noindex><a rel='nofollow' title='".__('Поширити у Yandex', $this->plugin_domain)."' href=\"http://share.yandex.ru/go.xml?service=yaru&url=".$url."&title=".$title."\">";
		...
		$googleplus .= "<noindex><a rel='nofollow' title='".__('Поширити у Google Plus', $this->plugin_domain)."' href=\"https://m.google.com/app/plus/x/?v=compose&content=".$title." - ".$url."\" onclick=\"window.open('https://m.google.com/app/plus/x/?v=compose&content=".$title." - ".$url."','gplusshare','width=450,height=300,left='+(screen.availWidth/2-225)+',top='+(screen.availHeight/2-150)+'');return false;\">";
		...
		/* Vkontakte */
		$vk_type .= "custom";
		$vk_text = '<img src="'.$this->plugin_url.'images/social/mini/vkontakte.png" title="'.__("Поширити у Vkontakte", $this->plugin_domain).'" alt="'.__("Share to Vkontakte", $this->plugin_domain).'"/>';
